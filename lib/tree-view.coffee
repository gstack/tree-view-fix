...
class TreeView extends View
  ...
  attach: ->
    ...
    # check for an old-instance of tree-view and (optionally) remove it.
    oldEl = document.querySelector('.tree-view-resizer.tool-panel')
    if oldEl and not atom.config.get('tree-view.shouldCreateTreeViews')
